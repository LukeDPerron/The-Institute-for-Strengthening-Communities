...
// Static at the top of the page; always transparent.
  ...
  return (
    <header className="w-full border-b border-transparent bg-transparent">
      ...
      >
        ...
        <button
          type="button"
          className={`inline-flex items-center rounded-md border px-3 py-1.5 text-sm font-medium transition-colors focus-visible:outline focus-visible:outline-2 focus-visible:outline-orange-500 md:hidden border-white/70 text-white hover:bg-white/10`}
