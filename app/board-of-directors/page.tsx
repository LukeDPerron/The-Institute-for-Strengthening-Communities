    ...
    <main className="bg-white">
      <div className="mx-auto max-w-7xl px-4 pb-14 pt-8 sm:px-6 sm:pb-16 sm:pt-10 lg:px-8">
        <header className="border-b border-slate-200 pb-12">
          <h1 className="text-center text-4xl font-bold tracking-tight text-slate-900 sm:text-5xl">Board of Directors</h1>
        </header>
            ...
            return (
              ...
              >
                ...
                <div>
                  ...
                  <p className="mt-2 text-sm font-semibold uppercase tracking-[0.12em] text-orange-700">{member.role}</p>
                  {member.bio ? (
                    <p className="mt-4 max-w-4xl text-base leading-7 text-slate-700">{member.bio}</p>
                  ) : null}
                </div>
              </article>
            );
